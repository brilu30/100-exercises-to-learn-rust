...
fn test_order() {
    ...
    assert_eq!(order.get_product_name(), "Rusty Book");
    assert_eq!(order.get_quantity(), &3);
    assert_eq!(order.get_unit_price(), &2999);
    ...
    assert_eq!(order.get_product_name(), "Rust Book");
    assert_eq!(order.get_quantity(), &2);
    assert_eq!(order.get_unit_price(), &3999);
